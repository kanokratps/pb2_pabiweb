...
import pb.repo.admin.service.DummySubModuleService;
...
@Component
@WebScript
public class AdminMainWorkflowHistoryWebScript {
	
	private static Logger log = Logger.getLogger(AdminMainWorkflowHistoryWebScript.class);
	
	private static final String URI_PREFIX = CommonConstant.GLOBAL_URI_PREFIX + "/admin/main/wf";
	
	@Autowired
	MainWorkflowService workflowService;
	
	@Autowired
	DummySubModuleService subModuleService;
	...
	public void handleAssigneeList(@RequestParam final String id,
		...
		try {
			workflowService.setModuleService(subModuleService);
