...
public class AdminMainAccountPettyCashWebScript {
	
	private static Logger log = Logger.getLogger(AdminMainAccountPettyCashWebScript.class);
	
	private static final String URI_PREFIX = CommonConstant.GLOBAL_URI_PREFIX + "/admin/main/pettycash";
	
	@Autowired
	private AdminAccountPettyCashService pettyCashService;
  ...
  public void handleList(
		...
		try {
			List<Map<String, Object>> list = pettyCashService.list(lang);
