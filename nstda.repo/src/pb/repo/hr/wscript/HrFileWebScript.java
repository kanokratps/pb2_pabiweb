...
@Component
@WebScript
public class HrFileWebScript {
	
	private static Logger log = Logger.getLogger(HrFileWebScript.class);
	
	private static final String URI_PREFIX = CommonConstant.GLOBAL_URI_PREFIX + "/hr/file";
  ...
  public void handleDelete(@RequestParam(required=false) final String name
	...
	log.info("-----HrFileWebScript.handleDelete("+path+"/"+name+")-----");
	String json = null;
  ...
  public void handleEdit(@RequestParam(required=false) final String name
	...
	log.info("-----HrFileWebScript.handleEdit("+path+"/"+name+"/"+desc+")-----");
	String json = null;
