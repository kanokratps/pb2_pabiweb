...
public class CompleteTask implements TaskListener {
	...
	//							}
							...
							action = mainWorkflowService.saveWorkflowHistory(session, executionEntity, curUser, MainWorkflowConstant.TN_REQUESTER, taskComment, finalAction, task,  model.getId(), level, model.getStatus());
